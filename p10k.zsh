# Generated by Powerlevel10k configuration wizard on 2021-07-03 at 20:08 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kctl|kall|tkn|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='ok|aws-okta|aws|awless|terraform|pulumi|terragrunt'
