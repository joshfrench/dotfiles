# Generated by Powerlevel10k configuration wizard on 2023-03-07 at 20:15 EST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean="%F{$colors[base0]}"
      local     staged="%F{$colors[green]}"
      local   modified="%F{$colors[yellow]}"
      local  untracked="%F{$colors[red]}"
      local conflicted="%F{$colors[red]}"
    else
    ...
    (( VCS_STATUS_COMMITS_BEHIND )) && res+="${clean}󱦳"
    (( VCS_STATUS_COMMITS_AHEAD  )) && res+="${clean}󱦲"
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=$colors[green]
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=$colors[green]
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$colors[base01]
